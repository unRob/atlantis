...
func (g *GithubAppWorkingDir) GetWorkingDir(r models.Repo, p models.PullRequest, workspace string) (string, error) {
	return g.WorkingDir.GetWorkingDir(r, p, workspace)
}

func (g *GithubAppWorkingDir) GetPullDir(r models.Repo, p models.PullRequest) (string, error) {
	return g.WorkingDir.GetPullDir(r, p)
}

func (g *GithubAppWorkingDir) Delete(r models.Repo, p models.PullRequest) error {
	return g.WorkingDir.Delete(r, p)
}

func (g *GithubAppWorkingDir) DeleteForWorkspace(r models.Repo, p models.PullRequest, workspace string) error {
	return g.WorkingDir.DeleteForWorkspace(r, p, workspace)
}
